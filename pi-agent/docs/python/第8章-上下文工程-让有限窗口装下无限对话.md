...
![工具输出截断：双重限制 + 双向策略](assets/260702-ch08-truncate-strategy.svg)
...
![多层 CLAUDE.md 递归 + Skills 懒加载](assets/260702-ch08-claude-md-recursion.svg)
...
![一次工具调用经过的完整上下文工程链路](assets/260702-ch08-full-pipeline.svg)
