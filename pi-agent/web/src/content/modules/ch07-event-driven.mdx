...
status: published
variant: ts
summary: 事件驱动是 Pi 的神经系统。同步屏障 + 发布订阅，让扩展和宿主协同。
prev: ch06-messages
...
diagrams:
  ...
  - id: 260702-ch07-sync-barrier
    file: /assets/260702-ch07-sync-barrier.svg
    caption: 同步屏障 vs Fire-and-Forget
  - id: 260702-ch07-text-delta-journey
    file: /assets/260702-ch07-text-delta-journey.svg
    caption: text_delta 的完整跨层旅程
...
<Diagram file="/assets/260702-ch07-sync-barrier.svg" caption="同步屏障 vs Fire-and-Forget" id="260702-ch07-sync-barrier" />
...
<Diagram file="/assets/260702-ch07-text-delta-journey.svg" caption="text_delta 的完整跨层旅程" id="260702-ch07-text-delta-journey" />
